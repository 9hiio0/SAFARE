...
<body>
    ...
    <script>
        ...
        var dangerCountries = [
            ...
            { name: "소말리아", lat: 5.1521, lng: 46.1996 },
            { name: "시리아", lat: 34.8021, lng: 38.9968 },
            { name: "멕시코", lat: 23.6345, lng: -102.5528 },
            { name: "남수단", lat: 6.8770, lng: 31.3070 },
            { name: "예멘", lat: 15.5527, lng: 48.5164 },
            { name: "이라크", lat: 33.2232, lng: 43.6793 },
